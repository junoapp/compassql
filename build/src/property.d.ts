...
export declare const ENCODING_TOPLEVEL_PROPS: Diff<"legend" | "type" | "axis" | "description" | "aggregate" | "bin" | "value" | "stack" | "format" | "scale" | "channel" | "field" | "timeUnit" | "sort" | "autoCount" | "hasFn", "description">[];
...
export declare const SCALE_PROPS: BaseEncodingNestedProp<"scale", Scale<import("vega-typings/types").SignalRef | import("vega-lite/build/src/expr").ExprRef>>[];
